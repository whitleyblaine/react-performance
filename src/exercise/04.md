...
In a data viz scenario, it's very useful to only render the cells that the user is looking at, and then 'lazy load' the other cells, to speed up performance.
This concept is called 'windowing'.
react-virtual is a library that helps you do this.
