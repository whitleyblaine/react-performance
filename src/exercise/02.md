...
Web Workers are epic! Lets the browser run simultaeous js scripts in multiple threads so you can do things "in the background" like an intense calculation (or btc mining haha)
