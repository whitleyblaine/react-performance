...
React exists in its current form in large part because updating the DOM takes a very long time, and therefore, by separating us from the DOM, React can perform the most optimal updates to the DOM and speed things up a lot.
